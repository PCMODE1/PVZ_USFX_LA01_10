...
#include "Trabajos/Factory_ Method/FactoryMethod_Main.h"
...
void APVZ_USFX_LAB02GameMode::TrabajosPatrones()
{
	AFactoryMethod_Main* FactoryMethod_Main = GetWorld()->SpawnActor<AFactoryMethod_Main>(AFactoryMethod_Main::StaticClass(), FVector(0, 0, 0), FRotator::ZeroRotator);
